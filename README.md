...
The server automatically loads 3 example recipes (Poutine, Shuba, Guo Bao Rou) from `sample-recipes.json` on startup. Edit this file and restart the server to see your changes.
